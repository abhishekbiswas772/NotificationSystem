...
type Users struct {
	...
	Username      string                   `gorm:"type:varchar(100);uniqueIndex:idx_user_username;not null"`
	Password      string                   `gorm:"type:varchar(255);not null"`
	CreatedAt     int64                    `gorm:"autoCreateTime:milli;index:idx_user_created"`
	...
	ResolvedDLQ   []NotificationDLQ        `gorm:"constraint:OnUpdate:CASCADE,OnDelete:SET NULL;foreignKey:ResolvedBy"`
}
